...
def add_preprocess_args(parser):
    ...
    group.add_argument("--target1-lang", default=None, metavar="TARGET",
                       help="target 1 language")
    group.add_argument("--target2-lang", default=None, metavar="TARGET",
    ...
    group.add_argument("--thresholdsrc", metavar="N", default=0, type=int,
                       help="map words appearing less than threshold times to unknown")
    group.add_argument("--tgt1dict", metavar="FP",
                       help="reuse given target 1 dictionary")
    group.add_argument("--tgt2dict", metavar="FP",
                       help="reuse given target 2 dictionary")
    ...
    group.add_argument("--joined-target-dictionary", action="store_true",
                       help="Generate joined target dictionary")
