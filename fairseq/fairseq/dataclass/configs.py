...
class GenerationConfig(FairseqDataclass):
    ...
    encode_source: bool = field(
        default=False,
        metadata={
            "help": "if set, only encode source sentences with the encoder"
        },
    )
    encode_type: str = field(
        default="mean",
        metadata={
            "help": "encoding type of source sentence. mean pooling or max pooling"
        }
    )
