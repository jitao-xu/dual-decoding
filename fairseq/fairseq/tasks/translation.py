...
class TranslationTask(LegacyFairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--prefix', default=0, type=int, metavar='N',
    ...
    def _inference_with_bleu(self, generator, sample, model):
        ...
        prefix_tokens = None
        if self.args.prefix > 0:
            prefix_tokens = sample["target"][:, : self.args.prefix]
        ...
        if self.args.eval_tokenized_bleu:
            ...
            if self.args.target_lang == "zh" or self.args.target_lang == "zhja":
                return sacrebleu.corpus_bleu(hyps, [refs], tokenize="zh")
            elif self.args.target_lang == "ja":
